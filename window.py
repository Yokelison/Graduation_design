...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/QQ.jpg"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="runs/train/exp_1/exp/weights/best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/uuu.PNG"))
        self.right_img.setPixmap(QPixmap("images/UI/www.PNG"))
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/right.jpeg"))
        ...
        label_super.setText("<a href='https://blog.csdn.net/ECHOSON'>")
        ...
        self.setTabIcon(0, QIcon('images/UI/QQ.jpg'))
        self.setTabIcon(1, QIcon('images/UI/QQ.jpg'))
